...
namespace eration
{
    public partial class eration9 : MetroFramework.Forms.MetroForm
    {
        public eration9()
        {
            InitializeComponent();
        ...
        private void eration9_Load(object sender, EventArgs e)
        {
            panel1.Hide();
            ...
            byte[] img = new byte[0];  //declaring byte type array to store image in binary format
            while (sdr.Read())
            {
